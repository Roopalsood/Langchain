...
try:
    ...
    first_chain = title_prompt | llm | StrOutputParser() | (lambda title: (st.write(title), title)[1]) #1 is title since (st.write(title), title) returns a tuple and we want the second element.
